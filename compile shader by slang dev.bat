...
.\cgpu\tools\slang\slangc examples\snake\color.slang -profile sm_5_0 -capability SPIRV_1_3 -entry vert -o examples\assets\shaderbin\color.vert.spv -O0 -g3 -line-directive-mode none -emit-spirv-directly -matrix-layout-row-major
.\cgpu\tools\slang\slangc examples\snake\color.slang -profile sm_5_0 -capability SPIRV_1_3 -entry frag -o examples\assets\shaderbin\color.frag.spv -O0 -g3 -line-directive-mode none -emit-spirv-directly -matrix-layout-row-major
