...
void scheduleSnakeMoveSystem(pulse::res<const UpdateContext> context, pulse::event_writer<SnakeMoveIntentEvent> snakeMoveWriter, flecs::entity entity, const Facing4W& direction, SnakeMove& move)
{	
