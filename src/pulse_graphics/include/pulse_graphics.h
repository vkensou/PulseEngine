...
static bool pulse_graphics_shader_library_is_alive(PulseAppId app, pulse_shader_library_t lib) { return pulse_asset_is_alive(app, pulse_graphics_shader_library_to_handle(lib)); }
static bool pulse_graphics_shader_library_is_ready(PulseAppId app, pulse_shader_library_t lib) { return pulse_asset_is_ready(app, pulse_graphics_shader_library_to_handle(lib)); }
bool pulse_graphics_shader_library_acquire(PulseAppId app, pulse_shader_library_t handle, pulse_graphics_shader_library_ref* ref);
void pulse_graphics_shader_library_release(PulseAppId app, pulse_graphics_shader_library_ref* ref);
static void pulse_graphics_shader_library_unload(PulseAppId app, pulse_shader_library_t lib) { pulse_asset_unload(app, pulse_graphics_shader_library_to_handle(lib)); }
...
static bool pulse_graphics_shader_is_alive(PulseAppId app, pulse_shader_t shader) { return pulse_asset_is_alive(app, pulse_graphics_shader_to_handle(shader)); }
static bool pulse_graphics_shader_is_ready(PulseAppId app, pulse_shader_t shader) { return pulse_asset_is_ready(app, pulse_graphics_shader_to_handle(shader)); }
...
static void pulse_graphics_shader_unload(PulseAppId app, pulse_shader_t shader) { pulse_asset_unload(app, pulse_graphics_shader_to_handle(shader)); }
...
static bool pulse_graphics_compute_shader_is_alive(PulseAppId app, pulse_compute_shader_t cs) { return pulse_asset_is_alive(app, pulse_graphics_compute_shader_to_handle(cs)); }
static bool pulse_graphics_compute_shader_is_ready(PulseAppId app, pulse_compute_shader_t cs) { return pulse_asset_is_ready(app, pulse_graphics_compute_shader_to_handle(cs)); }
...
static void pulse_graphics_compute_shader_unload(PulseAppId app, pulse_compute_shader_t cs) { pulse_asset_unload(app, pulse_graphics_compute_shader_to_handle(cs)); }
...
static bool pulse_graphics_buffer_is_alive(PulseAppId app, pulse_buffer_t buffer) { return pulse_asset_is_alive(app, pulse_graphics_buffer_to_handle(buffer)); }
static bool pulse_graphics_buffer_is_ready(PulseAppId app, pulse_buffer_t buffer) { return pulse_asset_is_ready(app, pulse_graphics_buffer_to_handle(buffer)); }
bool pulse_graphics_buffer_acquire(PulseAppId app, pulse_buffer_t handle, pulse_graphics_buffer_ref* ref);
void pulse_graphics_buffer_release(PulseAppId app, pulse_graphics_buffer_ref* ref);
static void pulse_graphics_buffer_unload(PulseAppId app, pulse_buffer_t buffer) { pulse_asset_unload(app, pulse_graphics_buffer_to_handle(buffer)); }
...
static bool pulse_graphics_sampler_is_alive(PulseAppId app, pulse_sampler_t sampler) { return pulse_asset_is_alive(app, pulse_graphics_sampler_to_handle(sampler)); }
static bool pulse_graphics_sampler_is_ready(PulseAppId app, pulse_sampler_t sampler) { return pulse_asset_is_ready(app, pulse_graphics_sampler_to_handle(sampler)); }
bool pulse_graphics_sampler_acquire(PulseAppId app, pulse_sampler_t handle, pulse_graphics_sampler_ref* ref);
void pulse_graphics_sampler_release(PulseAppId app, pulse_graphics_sampler_ref* ref);
static void pulse_graphics_sampler_unload(PulseAppId app, pulse_sampler_t sampler) { pulse_asset_unload(app, pulse_graphics_sampler_to_handle(sampler)); }
...
static bool pulse_graphics_texture_is_alive(PulseAppId app, pulse_texture_t texture) { return pulse_asset_is_alive(app, pulse_graphics_texture_to_handle(texture)); }
static bool pulse_graphics_texture_is_ready(PulseAppId app, pulse_texture_t texture) { return pulse_asset_is_ready(app, pulse_graphics_texture_to_handle(texture)); }
bool pulse_graphics_texture_acquire(PulseAppId app, pulse_texture_t handle, pulse_graphics_texture_ref* ref);
void pulse_graphics_texture_release(PulseAppId app, pulse_graphics_texture_ref* ref);
static void pulse_graphics_texture_unload(PulseAppId app, pulse_texture_t texture) { pulse_asset_unload(app, pulse_graphics_texture_to_handle(texture)); }
...
static bool pulse_graphics_mesh_is_alive(PulseAppId app, pulse_mesh_t mesh) { return pulse_asset_is_alive(app, pulse_graphics_mesh_to_handle(mesh)); }
static bool pulse_graphics_mesh_is_ready(PulseAppId app, pulse_mesh_t mesh) { return pulse_asset_is_ready(app, pulse_graphics_mesh_to_handle(mesh)); }
bool pulse_graphics_mesh_acquire(PulseAppId app, pulse_mesh_t handle, pulse_graphics_mesh_ref* ref);
void pulse_graphics_mesh_release(PulseAppId app, pulse_graphics_mesh_ref* ref);
static void pulse_graphics_mesh_unload(PulseAppId app, pulse_mesh_t mesh) { pulse_asset_unload(app, pulse_graphics_mesh_to_handle(mesh)); }
...
static bool pulse_graphics_material_is_alive(PulseAppId app, pulse_material_t material) { return pulse_asset_is_alive(app, pulse_graphics_material_to_handle(material)); }
static bool pulse_graphics_material_is_ready(PulseAppId app, pulse_material_t material) { return pulse_asset_is_ready(app, pulse_graphics_material_to_handle(material)); }
bool pulse_graphics_material_acquire(PulseAppId app, pulse_material_t handle, pulse_graphics_material_ref* ref);
void pulse_graphics_material_release(PulseAppId app, pulse_graphics_material_ref* ref);
static void pulse_graphics_material_unload(PulseAppId app, pulse_material_t material) { pulse_asset_unload(app, pulse_graphics_material_to_handle(material)); }
