...
namespace HGEGraphics
{
	...
	public:
		...
		GraphicsPipeline* getGraphicsPipeline(RenderPassEncoder* encoder, PulseShaderData* shader, PulseMeshData* mesh);
		GraphicsPipeline* getGraphicsPipeline(RenderPassEncoder* encoder, PulseShaderData* shader, ECGPUPrimitiveTopology prim_topology, const CGPUVertexLayout& vertex_layout);
