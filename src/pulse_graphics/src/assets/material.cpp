...
bool pulse_graphics_material_acquire(PulseAppId app, pulse_material_t handle, pulse_graphics_material_ref* material_ref) {
    pulse_asset_ref ref{};
...
void pulse_graphics_material_release(PulseAppId app, pulse_graphics_material_ref* material_ref) {
