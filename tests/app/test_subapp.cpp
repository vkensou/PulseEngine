...
int main(void) {
    ...
    assert(pulse_app_add_plugin(sub, &sub_plugin_desc) == PULSE_APP_ADD_PLUGIN_RESULT_OK);
    ...
    assert(sub2 != nullptr);
    assert(pulse_app_insert_subapp(app, "Sub2", sub2) == PULSE_APP_INSERT_SUBAPP_RESULT_OK);
