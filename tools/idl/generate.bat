...
.\lua54.exe generate-binding.lua ..\..\src\pulse_datatable\idl\pulse_datatable.idl ..\..\src\pulse_datatable\idl\temp.pulse_datatable.h c ..\..\src\pulse_datatable\include\pulse_datatable.h Pulse "    " PULSE_DATATABLE_API
