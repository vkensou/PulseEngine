...
target("example-snake-daslang-tables")
    set_group("examples")
    set_kind("shared")
    add_rules("pulse.package_install", {manifest = "examples/snake_daslang/package.json"})
    set_basename("snake_daslang_tables")
    add_deps("pulse_app")
    add_deps("pulse_config")
    add_deps("pulse_cpp_gameplay")
    add_deps("pulse_datatable")
    add_includedirs("examples/snake_daslang/schema")
    add_files("examples/snake_daslang/tables_plugin.cpp")
    add_files("examples/snake_daslang/schema/tables_generated.cpp")
