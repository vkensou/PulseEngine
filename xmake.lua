...
target("pulse_cgpu_render")
    set_kind("static")
    add_deps("pulse_app")
    add_deps("pulse_window")
    add_deps("rendergraph", {public = true})
    add_deps("cgpu", {public = true})
    add_includedirs("src/pulse_cgpu_render/include", {public = true})
    add_headerfiles("src/pulse_cgpu_render/include/*.h")
    add_files("src/pulse_cgpu_render/src/*.cpp")
...
target("test-cgpu-render")
    ...
    add_deps("pulse_window")
    add_deps("pulse_cgpu_render")
    add_files("tests/cgpu_render/*.cpp")
...
target("test-graphic")
    ...
    add_deps("pulse_asset")
    add_deps("pulse_cgpu_render")
    add_deps("pulse_graphic")
    add_files("tests/graphic/*.cpp")
