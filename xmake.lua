...
target("pulse_math")
    set_group("pacakges")
    set_kind("shared")
    add_rules("pulse.package_install", {manifest = "src/pulse_math/package.json"})
    add_defines("PULSE_MATH_MODULE_BUILD")
    add_deps("pulse_platform")
    add_deps("pulse_app")
    add_deps("pulse_config")
    add_includedirs("src/pulse_math/include", {public = true})
    add_headerfiles("src/pulse_math/include/*.h")
    add_files("src/pulse_math/src/*.cpp")
...
target("pulse_prefab")
    set_group("pacakges")
    set_kind("shared")
    add_rules("pulse.package_install", {manifest = "src/pulse_prefab/package.json"})
    add_defines("PULSE_PREFAB_MODULE_BUILD")
    add_deps("pulse_platform")
    add_deps("pulse_app")
    add_deps("pulse_config")
    add_deps("pulse_asset")
    add_deps("pulse_datalist")
    add_includedirs("src/pulse_prefab/include", {public = true})
    add_headerfiles("src/pulse_prefab/include/*.h")
    add_files("src/pulse_prefab/src/*.cpp")

target("pulse_datatable")
    set_group("pacakges")
    set_kind("shared")
    add_rules("pulse.package_install", {manifest = "src/pulse_datatable/package.json"})
    add_defines("PULSE_DATATABLE_MODULE_BUILD")
    add_deps("pulse_platform")
    add_deps("pulse_app")
    add_deps("pulse_config")
    add_deps("pulse_asset")
    add_deps("pulse_datalist")
    add_includedirs("src/pulse_datatable/include", {public = true})
    add_headerfiles("src/pulse_datatable/include/*.h")
    add_files("src/pulse_datatable/src/*.cpp")
...
target("pulse_text")
    set_group("pacakges")
    set_kind("shared")
    add_rules("pulse.package_install", {manifest = "src/pulse_text/package.json"})
    add_defines("PULSE_TEXT_MODULE_BUILD")
    add_deps("pulse_platform")
    add_deps("pulse_app")
    add_deps("pulse_config")
    add_deps("pulse_font")
    add_includedirs("src/pulse_text/include", {public = true})
    add_headerfiles("src/pulse_text/include/*.h")
    add_headerfiles("src/pulse_text/src/*.h", {install = false})
    add_files("src/pulse_text/src/*.cpp")
...
target("tablegen")
    ...
    set_kind("binary")
    add_defines("PULSE_DATALIST_MODULE_BUILD")
    add_deps("pulse_datalist_static")
    add_includedirs("tools/tablegen")
    add_files("tools/tablegen/*.cpp")
...
for _, test_file in ipairs(os.files("tests/datatable/test_*.cpp")) do
    local test_name = "test-datatable-" .. path.basename(test_file):gsub("^test_", "")
    target(test_name)
        set_group("tests")
        set_kind("binary")
        set_default(false)
        set_rundir("$(projectdir)")
        set_exceptions("cxx")
        add_includedirs("tests/datatable/schema")
        add_deps("pulse_app")
        add_deps("pulse_config")
        add_deps("pulse_vfs")
        add_deps("pulse_asset")
        add_deps("pulse_datatable")
        if path.basename(test_file) == "test_daslang" then
            add_includedirs("tests/daslang")
            add_deps("pulse_daslang")
            add_deps("pulse_prefab")
        end
        add_cxflags("/bigobj")
        add_files(test_file)
        add_files("tests/datatable/schema/tables_generated.cpp")
        add_files("tests/helper/msvc_headless_asserts.c")
        add_tests("default", {group = "datatable", rundir = "$(projectdir)"})
end
...
for _, test_file in ipairs(os.files("tests/text/test_*.cpp")) do
    local test_name = "test-text-" .. path.basename(test_file):gsub("^test_", "")
    target(test_name)
        set_group("tests")
        set_kind("binary")
        set_default(false)
        set_rundir("$(projectdir)")
        add_includedirs("tests/text")
        add_deps("pulse_app")
        add_deps("pulse_config")
        add_deps("pulse_vfs")
        add_deps("pulse_asset")
        ...
        add_files(test_file)
        add_files("tests/helper/msvc_headless_asserts.c")
        add_tests("default", {group = "text", rundir = "$(projectdir)"})
end

target("test-text-window")
    set_group("tests")
    set_kind("binary")
    set_rundir("$(projectdir)")
    add_includedirs("tests/text")
    ...
    add_deps("pulse_font")
    add_deps("pulse_text")
    add_files("tests/text/text_window.cpp")
    add_files("tests/helper/msvc_headless_asserts.c")
    add_rules("pulse.window_screenshot_test", {baseline = "tests/text/baseline.png", wait = 5, threshold = 0.995})
    add_tests("default", {group = "text-window", rundir = "$(projectdir)"})
...
target("test-prefab")
    ...
    add_deps("pulse_renderer")
    add_deps("pulse_prefab")
    add_files("tests/prefab/*.cpp")
    add_files("tests/helper/msvc_headless_asserts.c")
    add_tests("default", {group = "prefab", rundir = "$(projectdir)"})
